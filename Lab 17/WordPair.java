 ...
 *  Partner: None 
 *  CSE 271 HA 
 *  WordPair takes a set of words seperated by an = sign
 * and creats a WordPair object
 */
...
public class WordPair implements Comparator<WordPair> {
  ...
  * 
  * @param WordPair to be tested against
  * 
 ...
 public boolean equals(WordPair aPair) {
  ...
  // COMPLETE THIS METHOD
    ...
    if(aPair.toString().equals(this.toString()))
    result = true;
 ...
 public static void main(String[] args) {
  ...
  //add words to the new LinkedList
  ...
  System.out.println("\nTesting the equals method");
  System.out.println(list1.get(0).equals(words[0])); //true
  System.out.println(list1.get(0).equals(words[1])); //false
