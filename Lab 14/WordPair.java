 ...
 *  Partner: None 
 *  CSE 271 HA 
 *  WordPair class takes a string of words and 
 * distinguishes them using the = sign
 */
...
public class WordPair implements Comparable<WordPair> {
  ...
  public int compareTo(WordPair bWord)
  {
    return (this.getWordA().compareTo(bWord.getWordA()));
  }
